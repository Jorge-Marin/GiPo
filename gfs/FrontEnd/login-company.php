...
?>
  ...
  <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom box-shadow">
      ...
      <div class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" style='color:black' href="http://example.com" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Crear una Cuenta</a>
      ...
      <div class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" style='color:black' href="http://example.com" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Iniciar Sesion</a>
          <div class="dropdown-menu" aria-labelledby="dropdown01">
      ...
      <div class="row login-div">
        <div class="col-xl-12">
          ...
          <form id="form-login">
              ...
              <input id="email" name="email" type="text" placeholder="Email" value="SkullCandyOfficialHN@gmail.com" class="email"><br>
              <label style="padding-left: 8px;">Password</label>
              <input id="password" type="password" name="password" value="Giasekando1"  placeholder="Password" class="password-text"><br>
              <button id="btn-login" type="button" class="btn-logotype">Login</button><br>
          </form>
          <div class="checkbox">
    ...
    <script src='js/controller-login-company.js'></script>
  </body>
  </html>
